 ...
 * {@link #sendBroadcast(bgu.spl.mics.Broadcast)}, {@link #sendBroadcast(bgu.spl.mics.Broadcast)},                           //---IMPORTANT---//
...
//FIELDS
    ...
    private HashMap<Class<?extends Message>, Callback> callbackMessageTypes;
    ...
    public MicroService(String name) {
        _name = name;
        callbackMessageTypes = new HashMap<Class<?extends Message>, Callback>();
        event = new HashMap<Event,Future>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback)  {
        ...
        if(!callbackMessageTypes.containsKey(type)){
            callbackMessageTypes.put(type,callback);
        }
    }
     ...
     *               {@code e}.
     */
    protected final <T> void complete(Event<T> e, T result) throws Exception {
    ...
    public final void run() {
        ...
        while(!Thread.currentThread().isInterrupted()){
            ...
            try {
                ...
                Callback callback = callbackMessageTypes.get(message.getClass());
                try {
